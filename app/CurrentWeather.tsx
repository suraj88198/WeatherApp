...
export function CurrentWeather({ data }: { data: any }) {
  ...
  return (
    <div className="bg-white/20 dark:bg-zinc-800/50 shadow-xl rounded-2xl p-6 text-left backdrop-blur-md flex items-center md:justify-between flex-wrap justify-center">
      <div>
